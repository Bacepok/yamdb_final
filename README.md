...
http://84.252.130.53/api/v1/ - API проекта

http://84.252.130.53/admin/ - админка проекта

http://84.252.130.53/redoc/ - документация 
...
<code>git clone git@github.com:Bacepok/api_yamdb.git</code>
...
### Ссылка на образз проекта на Docker:
https://hub.docker.com/r/bacep/api_yamdb

### Примеры запросов:

<br>POST http://127.0.0.1/api/v1/auth/signup/
<pre><code>
{
...
<br>POST http://127.0.0.1/api/v1/auth/token/
Получаем токен.
<pre><code>
{
  "username": "string",
...
GET http://127.0.0.1/api/v1/categories/<br>
<pre><code>
{
  "count": 0,
  "next": "string",
...
DELETE http://127.0.0.1/api/v1/titles/{titles_id}/
